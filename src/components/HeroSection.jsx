  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto flex flex-col items-center text-center">
        <motion.div variants={fadeInUp} className="mb-8 border-neutral-800 px-3 py-2 rounded-full">
        ...
        <motion.p variants={fadeInUp} className="mt-6 text-neutral-400 max-w-xl">{HERO_CONTENT.subHeading}</motion.p>
        ...
        <motion.div variants={fadeInUp} className="py-10">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            {BRAND_LOGOS.map((logo, index) => {
              return <img key={index} src={logo.src} alt={logo.alt} className="h-8" />;
            })}
          </div>
        </motion.div>
